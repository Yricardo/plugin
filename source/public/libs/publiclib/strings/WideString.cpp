//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/libs/publiclib/strings/WideString.cpp $
//  
//  Owner:
//  
//  $Author: devtecbj $
...
void WideString::Invariant() const
{
	...
	if (WideString::ts_ForceRoundtrip && !fForcingRoundtrip)
	{
		fForcingRoundtrip = kTrue;
