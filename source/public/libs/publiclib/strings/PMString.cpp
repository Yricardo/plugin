//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/libs/publiclib/strings/PMString.cpp $
//  
//  Owner: 
//  
//  $Author: devtecbj $
...
void PMString::SetUTF8String(const std::string &utf8String)
{
	...
	try
	{
		UTF16TextChar *unicodeBufferEnd = adobe::detail::to_utf16<UTF16TextChar>(utf8String.begin(), utf8String.end(), unicodeBuffer, adobe::detail::unicode_size_type_<sizeof(char)>());
		fUTF16BufferLength = unicodeBufferEnd - unicodeBuffer;
		ASSERT_MSG((len == 0 || fUTF16BufferLength > 0) && fUTF16BufferLength <= len, "Error converting UTF8 string");
	}
	catch(std::runtime_error error)
	{
		ASSERT_FAIL(FORMAT_ARGS("PMString::SetUTF8String - Error converting UTF8 string - %s", error.what()));
