//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/libs/publiclib/links/FileLinkResourceHandler.cpp $
//  
...
//========================================================================================
// FileLinkResourceHandler::CanRevealResourceInMiniBridge
//========================================================================================
bool FileLinkResourceHandler::CanRevealResourceInMiniBridge(const UIDRef& ref, const URI& uri) const
{
	return fbInited; // if we can have a file, we can reveal it - right?
}

//========================================================================================
// FileLinkResourceHandler::RevealResourceInMiniBridge
//========================================================================================
ErrorCode FileLinkResourceHandler::RevealResourceInMiniBridge(const UIDRef& ref, const URI& uri) const
{
	return (fbInited ? FileUtils::BrowseToFileInMiniBridge(&fFile) : kFailure);
}
