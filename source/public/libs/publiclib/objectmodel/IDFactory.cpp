//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/libs/publiclib/objectmodel/IDFactory.cpp $
//  
...
IDFactory::IDFactory(const int32& space, char* name, const int32& id) :
	fNextID(fgFirstID),
	fSpace(space),
	fName(name),
	fId(id)
...
void IDFactory::InstallIDs(PluginID ownerComponent)
{
	...
	om->RegisterID(kInvalidPlugin, kPlugInIDSpace, static_cast<char*>(nil), kInvalidPlugin.Get()) ;
}
