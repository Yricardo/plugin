//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/libs/widgetbin/trackers/CTracker.cpp $
//  
...
bool16 CTracker::BeginTracking(IEvent* theEvent)
{
	...
	bool16 continueTracking = this->DoBeginTracking(theEvent);
