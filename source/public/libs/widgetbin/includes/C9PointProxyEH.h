//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/libs/widgetbin/includes/C9PointProxyEH.h $
//  
//  Owner:
//  
//  $Author: gmatthew $
...
public:
	...
	enum
	{
		kMainDiamondHeight = 21,
		kCornerDiamondHeight = 7,
		kMainSquareHeight = 15,
		kCornerSquareHeight = 5,
		kLineSquareHeight = 5
	};
