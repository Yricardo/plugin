//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/libs/widgetbin/includes/DVHostedWidgetEH.h $
//  
//  Owner: Dave Burnard
//  
//  $Author: devtecbj $
...
public:
	...
	virtual ~DVHostedWidgetEH();
		...
		virtual char* class_name()					{static char* name = "DVHostedWidgetEH"; return name;}
protected:
