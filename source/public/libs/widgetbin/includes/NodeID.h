//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/libs/widgetbin/includes/NodeID.h $
//  
//  Owner: Matt Joss
//  
//  $Author: gmatthew $
...
public:
	...
	NodeID_rv(const NodeID_rv& other) { fNodeID = other.Relinquish(); }
	...
	NodeIDClass*	Relinquish() const { NodeIDClass* tempNodeID = fNodeID; fNodeID = nil; return tempNodeID; }
