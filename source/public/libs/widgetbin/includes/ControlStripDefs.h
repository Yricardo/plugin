//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/libs/widgetbin/includes/ControlStripDefs.h $
//  
//  Owner: Paul Sorrick
//  
//  $Author: devtecbj $
//  
//  $DateTime: 2015/04/24 23:35:43 $
//  
//  $Revision: #4 $
//  
//  $Change: 909778 $
...
#define kControlStripMenuPanelWidth					20
#define kControlStripMinWidth						kControlStripMenuPanelWidth
...
#define kControlStripMenuBottom						20
...
#define kParagraphShadingControlStripSet			ControlStripWidgetInfo (kParaShadingControlStripRsrcID, \
														kParagraphPanelPluginID, \
...
#define kParagraphShadingOffsetControlStripSet		ControlStripWidgetInfo (kParaShadingControlStripRsrcID, \
														kParagraphPanelPluginID, \
