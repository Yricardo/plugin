//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/includes/PMString.h $
//  
//  Owner: EricM
//  
//  $Author: devtecbj $
...
class PUBLIC_DECL PMString : public UnicodeSavvyString
{
	public:
		...
		*/
		 ...
		 */
		friend void swap( PMString& left, PMString& right );

		/** operator assignment on a movable type takes parameter by value and consumes it
		 */
		inline PMString& operator=(PMString other)
		{
			swap(*this, other);
			return *this;
		}
...
inline void swap( PMString& left, PMString& right )
{
	// Base class swap
