//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/includes/FileUtils.h $
//  
//  Owner: Robin_Briggs
//  
//  $Author: devtecbj $
...
public:
	...
	*/
	...
	static void SwapFiles(const IDFile& file1, const IDFile& file2);
	...
	*/
	...
	static ErrorCode BrowseToFileInMiniBridge(const IDFile *fileSpec, ViewMode mode = kNormal);
