//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/includes/TextAttrScriptUtility.h $
//  
//  Owner: Jonathan W. Brown
//  
//  $Author: devtecbj $
//  
//  $DateTime: 2015/04/29 23:36:01 $
//  
//  $Revision: #4 $
//  
//  $Change: 910377 $
...
template<class T, class S> ErrorCode Accessor<T,S>::Access( IScriptRequestData* data, IScript* script, const ScriptID& propID )
{
	...
	else if (data->IsPropertyPut())
	{
		...
		{
			S val;
			err = fMap.GetForSetProperty( script, data, propID, (int32&)val ) ;
			if (err != kSuccess) return err;
