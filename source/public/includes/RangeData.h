//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/includes/RangeData.h $
//  
//  Owner: sheridan
//  
//  $Author: gmatthew $
...
public:
	...
	//Constructors
	RangeData( const RangeData& r, const RangeData* clip = nil);
...
namespace Text {
	...
	{
		public:
			StoryRange( const StoryRange& r) : RangeData(r) {}
