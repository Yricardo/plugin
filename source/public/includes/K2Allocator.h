//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/includes/K2Allocator.h $
//  
//  Owner: Mat Marcus
//  
//  $Author: gmatthew $
...
#ifdef MACINTOSH
	K2Allocator(const K2Allocator&);	// get un-inlined inline warnings without this
#endif
...
#ifdef MACINTOSH
template <class T>
inline K2Allocator<T>::K2Allocator(const K2Allocator&) {}
#endif
