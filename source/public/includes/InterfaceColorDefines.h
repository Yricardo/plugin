//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/includes/InterfaceColorDefines.h $
//  
...
const int32   kInterface28Gray			=   40; // 28% Gray
...
const int32   kInterfaceColorCount		=   65;       // this is needed for counting purpose, always set as last value
#endif
