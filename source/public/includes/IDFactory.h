//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/includes/IDFactory.h $
//  
...
#define CONST_INT_DECLARE_PMID
	...
	#define DECLARE_PMID(space, name, id) enum { name = id };
		...
		#define DECLARE_PMID(space, name, id) const uint32 name = id;
...
public:
	...
	*/
	IDFactory(const int32& space, char* name, const int32& id);
