//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/includes/BaseType.h $
//  
//  Owner: ?
//  
//  $Author: gmatthew $
...
class UTF32TextChar
{
	public:
		...
		*/
		inline UTF16TextChar CalcHighSurrogate() const { return (fCharacterValue > 0xFFFF ? ((fCharacterValue - 0x10000) / 0x400 + 0xd800) : fCharacterValue); }
		
		/** Return the low order 16 bit value
			@return UTF16TextChar low order 16-bits
		*/
		inline UTF16TextChar CalcLowSurrogate() const { return (fCharacterValue > 0xFFFF ? ((fCharacterValue - 0x10000) % 0x400 + 0xdc00) : fCharacterValue); }
