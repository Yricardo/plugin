//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/includes/OMTypes.h $
//  
//  Owner: 
//  
//  $Author: gmatthew $
...
// Global operators
template<class T>
inline bool operator<(const IDType<T>& lhs, const IDType<T>& rhs)
{
