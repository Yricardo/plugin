//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/includes/UnicodeSavvyString.h $
//  
//  Owner:
//  
//  $Author: devtecbj $
...
public:
	...
	*/
	friend inline void swap(UnicodeSavvyString& lhs, UnicodeSavvyString& rhs)
	{
...
protected:
	 ...
	 */
	void move_from(UnicodeSavvyString& other)
	{
