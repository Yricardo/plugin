//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/includes/CSprite.h $
//  
//  Owner: Jack Kirstein
//  
//  $Author: devtecbj $
	...
	*/
	...
	virtual bool16 NeedsUpdate(const PMPoint& where, int32 flags) const
	{
		...
		return (IsPatientUser (flags) &&
				((where != fCurrentPoint) ||
				 (where != fLastCompositionPoint && (::TickCount() - fLastCompositionTicks > kSubsequentCompositionThreshold))));
	}
...
protected:	
	...
	*/
	...
	K2Vector<PMReal>	fRGBColorValue;
	IDataBase*	fDataBase;
	PMMatrix	fXformFromLastShow;
	bool	fDoRevealAllImageData;
	bool	fSmartGuidesDrawn;
	bool	fDrawSmartGuides;
