//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/includes/PMPathPoint.h $
//  
//  Owner: jargast
//  
//  $Author: gmatthew $
...
public: 
	...
	*/
	PMPathPoint (const PMPoint& linePt);
	...
	*/
	const PMPoint& GetLeftDirPoint () const;
	/** @return the anchor point.
	*/
	const PMPoint& GetAnchorPoint () const;
	/**	@return the right direction point.
	*/
	const PMPoint& GetRightDirPoint () const;
	
	/**	Returns the anchor type. This should be one of kL, kCS, or kCK.
		@see PathTypes.h
	*/
	PMPathPointType GetAnchorType() const;
	...
	*/
	...
	/**	Sets the left direction point with the specified new point.
		@param newPoint is the new point to set to.
	*/
	void SetLeftDirPoint( const PMPoint& newPoint );
	/**	Sets the anchor point with the specified new point.
		@param newPoint is the new point to set to.
	*/
	void SetAnchorPoint( const PMPoint& newPoint );
	/**	Sets the right direction point with the specified new point.
		@param newPoint is the new point to set to.
	*/
	void SetRightDirPoint( const PMPoint& newPoint );
	...
	*/
	...
	/**
	*/
	PMPathPoint& operator=(const PMPathPoint& rhs);

	// Comparison Operators
	/**	Compare two PMPathPoint.
		@return true if two PMPathPoint are equal.
	*/
	friend PUBLIC_DECL bool16 operator ==(const PMPathPoint& a, const PMPathPoint& b);
	/**	Compare two PMPathPoint.
