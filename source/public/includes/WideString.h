//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/includes/WideString.h $
//  
//  Owner: Nat McCully
//  
//  $Author: devtecbj $
...
//		typedef WideStringUTF32Iter			iterator;
		...
		*/
		...
		/** Assignment operator - this class is movable so we pass the argument by value. */
...
public:
	...
	mutable bool16 fForcingRoundtrip;
private:
