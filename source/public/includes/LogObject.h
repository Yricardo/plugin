//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/includes/LogObject.h $
//  
//  Owner: lance bushore
//  
//  $Author: gmatthew $
 ...
 */
		void	WriteLog(bool16 terminateLine, char *format, ... );
...
/**
	...
	@param terminateLine If kTrue, a line terminator is further appended.
 */
		void	WriteLogFormat(char *format, va_list argptr, bool16 terminateLine = kTrue );
