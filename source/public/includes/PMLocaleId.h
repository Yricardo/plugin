//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/includes/PMLocaleId.h $
//  
...
*/
	...
	inline		PMLocaleId(const PMLocaleId& other);

/**		Assignment operator
*/
	inline		PMLocaleId& operator=(const PMLocaleId& other);
...
*/
				U_ICU_NAMESPACE::Locale	GetUserInterfaceICULocale() const;
...
*/
				void	SetUserInterface(U_ICU_NAMESPACE::Locale newLocale);
...
inline PMLocaleId::PMLocaleId(const PMLocaleId& other) :
	fFeatureSetId(other.fFeatureSetId),
	fUserInterfaceId(other.fUserInterfaceId)
{
}

inline PMLocaleId& PMLocaleId::operator=(const PMLocaleId& other)
{
	if (&other != this)
	{
		fFeatureSetId = other.fFeatureSetId;
...
{
	int16 product = fFeatureSetId & 0xFF00;
#if 1
	return ((product == (int16)kAllProductsFS) || (productFS == (int16)kAllProductsFS) || (product == productFS));
#else
