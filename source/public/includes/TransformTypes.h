//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/includes/TransformTypes.h $
//  
//  Owner: psorrick
//  
//  $Author: gmatthew $
...
namespace Transform
{
	...
	struct CoordinateSpace
	{
		...
		CoordinateSpace( const CoordinateSpace& other) : base_space( other.base_space), final_space(other.final_space) { }
...
namespace Geometry
{
	...
	struct ResizeMethod
	{
		...
		ResizeMethod( const ResizeMethod& other) : resize_method( other.resize_method) { }
	...
	struct BoundsKind
	{
		...
		BoundsKind( const BoundsKind& other) : bounds_kind( other.bounds_kind) { }
	...
	struct ResizeConstraint
	{
		...
		ResizeConstraint( const ResizeConstraint& other) : resize_constraint( other.resize_constraint) { }
...
namespace Transform
{
	...
	struct Target
	{
		...
		Target( const Target& other) : transform_target( other.transform_target) { }
	...
	struct Action
	{
		...
		Action( const Action& other) : transform_action( other.transform_action) { }
	...
	struct LocationSpace
	{
		...
		LocationSpace( const LocationSpace& other) : location_space( other.location_space) { }
...
//		friend bool operator!=( const TransformOrigin& lhs, const TransformOrigin& rhs) { return !(lhs == rhs); }
	...
	*/
	...
	struct ScaleMethod
	{
		...
		ScaleMethod( const ScaleMethod& other) : scale_method( other.scale_method) { }
