//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/includes/PMRect.h $
//  
...
extern PUBLIC_DECL const PMRect kZeroRect;
...
class PUBLIC_DECL PMRect
{
	public:
		 ...
		 */
		explicit PMRect(const PMPoint& point);
		 ...
		 */
		PMRect(const PMPoint& one_corner, const PMPoint& opposing_corner);
		 ...
		 */
		PMRect(const PMReal& l, const PMReal& t, const PMReal& r, const PMReal& b);
		 ...
		 */
		explicit PMRect( const dvacore::geom::RectT<float>& r);
		 ...
		 */
		explicit PMRect( const Int32Rect& r);
#endif
		 ...
		 */
		bool16 IsCorner(PointIndex whichPoint) const;
		...
		/**
		 ...
		 @param whichPoint	IN The point index to test
		 */
		bool16 IsMiddle(PointIndex whichPoint) const;
		 ...
		 */
		bool16 PointIn(const PMPoint& pt) const;
		...
		/**
		 ...
		 @return kTrue if the point falls within the rectangle, else kFalse
		 */
		bool16 ContainsPoint(const PMPoint& pt) const;
		 ...
		 */
		bool16 RectIn(const PMRect& r) const;
		...
		/**
		 ...
		 @return kTrue if the rectangle r is contained with this rectangle, else kFalse
		 */
		bool16 ContainsRect( const PMRect& r) const;
		 ...
		 */
		PMPoint RightBottom(void) const;
		 ...
		 */
		void RightBottom(const PMPoint& pt);
		 ...
		 */
		void RightTop(const PMPoint& pt);
		 ...
		 */
		void LeftBottom(const PMPoint& pt);
		 ...
		 */
		friend PUBLIC_DECL bool16 operator ==(const PMRect& a, const PMRect& b);
...
inline bool16 PMRect::IsEmpty() const
{
	return ((left == right) || (top == bottom));
}
			
inline bool16 PMRect::IsCorner(PointIndex whichPoint) const
{
...
inline bool16 PMRect::IsMiddle(PointIndex whichPoint) const
{
...
inline bool16 PMRect::PointIn(const PMPoint& pt) const
{
	return (pt.x >= left) && (pt.x <= right) && (pt.y >= top)  && (pt.y <= bottom);
}

inline bool16 PMRect::ContainsPoint(const PMPoint& pt) const
{
	return 
...
inline bool16 PMRect::RectIn(const PMRect& r) const
{
	return (top <= r.top && bottom >= r.bottom) && (left <= r.left && right >= r.right);
}

inline bool16 PMRect::ContainsRect(const PMRect& r) const
{
	return
...
inline const PMReal& PMRect::Left() const
{
	return left;
}
			
inline PMReal& PMRect::Left()
{
	return left;
}

inline void PMRect::Left(const PMReal& c)
{
	left = c;
}
			
inline const PMReal& PMRect::Top() const
{
	return top;
}
			
inline PMReal& PMRect::Top()
{
	return top;
}

inline void PMRect::Top(const PMReal& c)
{
	top = c;
}
			
inline const PMReal& PMRect::Right() const
{
	return right;
}
			
inline PMReal& PMRect::Right()
{
	return right;
}

inline void PMRect::Right(const PMReal& c)
{
	right = c;
}
			
inline const PMReal& PMRect::Bottom() const
{
	return bottom;
}
			
inline PMReal& PMRect::Bottom()
{
	return bottom;
}

inline void PMRect::Bottom(const PMReal& c)
{
	bottom = c;
}
			
inline PMPoint PMRect::LeftTop() const
{
	return PMPoint(left, top);
}
			
inline void PMRect::LeftTop(const PMPoint& pt)
{
 	left = pt.X(); top = pt.Y();
}
			
inline PMPoint PMRect::RightBottom() const
{
	return PMPoint(right, bottom);
}
			
inline void PMRect::RightBottom(const PMPoint& pt)
{
 	right = pt.X(); bottom = pt.Y();
}

inline PMPoint PMRect::RightTop() const
{
	return PMPoint(right, top);
}
			
inline void PMRect::RightTop(const PMPoint& pt)
{
 	right = pt.X(); top = pt.Y();
}
			
inline PMPoint PMRect::LeftBottom() const
{
	return PMPoint(left, bottom);
}
			
inline void PMRect::LeftBottom(const PMPoint& pt)
{
 	left = pt.X(); bottom = pt.Y();
}
			
inline PMReal PMRect::Height() const
{
	return bottom - top;
}
			
inline PMReal PMRect::Width() const
{
	return right  - left;
}

inline PMPoint PMRect::Dimensions() const
{
...
inline bool16 operator ==(const PMRect& a, const PMRect& b)
{
