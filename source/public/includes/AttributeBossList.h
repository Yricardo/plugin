//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/includes/AttributeBossList.h $
//  
//  Owner: Eric_Menninga
//  
//  $Author: devtecbj $
...
public:
	...
	IDAttributeList(const IDAttributeList & other) : fAttributeList(other.fAttributeList), fDB(other.fDB) {}
