//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/interactive/ui/MediaUIID.h $
//  
//  Owner: wtislar
//  
//  $Author: gmatthew $
...
// For panel geometry
#define kVideoWidgetsHeight							112 // includes Play on Page Load checkbox thru Show Controller on Rollover checkbox
#define kVideoPanelDefaultHeight					438	// includes preview area thru "+" and "-" buttons
#define kVideoPanelCollapsedHeight					335

#ifdef MACINTOSH
#define kMediaPanelDefaultHeight					468
#define kBottomButtonPanelHeight					30
#else
#define kMediaPanelDefaultHeight					466
#define kBottomButtonPanelHeight					28
#endif

#define kMediaPanelDefaultWidth						270 // new wider width to accommodate localization.
#define kAudioPanelDefaultHeight					298
#define kSWFPanelDefaultHeight						256

#define kPreviewPlayerWidgetHeight					203
#define kPreviewAreaHeight							206 // includes player widget and the separator bar
#define kNavigationPointsListBoxWidgetHeight		80
#define kNavigationPointsListPanelWidgetHeight		100
...
#define kMediaLabelWidgetWidth_DE						75
#define kMediaLabelWidgetWidth_FR						85
#define kMediaLabelWidgetWidth_ES						58
#define kMediaLabelWidgetWidth_NL						50
#define kMediaLabelWidgetWidth_HU						65
#define kMediaLabelWidgetWidth_UA						55
