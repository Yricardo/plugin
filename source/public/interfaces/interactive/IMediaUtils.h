//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/interactive/IMediaUtils.h $
//  
//  Owner: wtislar
//  
//  $Author: gmatthew $
...
public:
	...
	*/
	virtual ErrorCode	CreateMediaWithDefaultPoster( ClassID mediaClassID, IDataBase * db, UID & outMediaUID, const ClassID formatClassID = kInvalidClass, IPMStream * mediaImportStream = nil ) = 0;
