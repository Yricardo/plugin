//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/colormgmt/ICMSManager.h $
//  
//  Owner: fhaberma
//  
//  $Author: devtecbj $
...
public:
	enum { kDefaultIID = IID_ICMSMANAGER };
		...
		enum ErrorCodes { 
					kSuccess=0,				// No problems
					 kMissingProfiles, 	// No profiles are installed 
					 kACEFailure,			// ACE is reporting some sort of error
					 kCMSGFailure,			// The CMSG currently used is having problems
					 kNoMemory,				// Not enough memory
					 kUnknown				// Something strange happened
					 };
		...
		// ----------------------------------------------
			...
			// Obtains the internal CMS error code (if any).
