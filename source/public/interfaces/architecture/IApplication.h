//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/architecture/IApplication.h $
//  
//  Owner: Robin Briggs
//  
//  $Author: gmatthew $
...
public:
	...
	*/
	...
	/** Return a string identifying the package version of the application. (e.g. "CS2" or "CS2_J")
	*/
