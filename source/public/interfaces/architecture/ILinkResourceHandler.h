//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/architecture/ILinkResourceHandler.h $
//  
...
public:
	...
	/**
	 Called to determine if a resource can be revealed in Adobe Mini Bridge
	 @param ref [IN] UID reference of the link resource.
	 @param uri [IN] URI of the resource to check.
	 @return True if the resource can be revealed, else false.
	 */
	virtual bool CanRevealResourceInMiniBridge(const UIDRef& ref, const URI& uri) const = 0;
	
	/**
	 Called to reveal a resource in Adobe Mini Bridge
	 @param ref [IN] UID reference of the link resource.
	 @param uri [IN] URI of the resource to reveal.
	 @return kSuccess if the resource was successfully revealed, else an error code.
	 */
	virtual ErrorCode RevealResourceInMiniBridge(const UIDRef& ref, const URI& uri) const = 0;
