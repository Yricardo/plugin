//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/architecture/ImportExportUIID.h $
//  
...
DECLARE_PMID(kServiceIDSpace, kPublishSelectableDialogService,		kImportExportUIPrefix + 8)
...
DECLARE_PMID(kClassIDSpace, kPublishSelectableDialogBoss,				kImportExportUIPrefix + 60)
DECLARE_PMID(kClassIDSpace, kPublishGeneralPanelBoss,					kImportExportUIPrefix + 61)
DECLARE_PMID(kClassIDSpace, kPublishImagePanelBoss,						kImportExportUIPrefix + 62)
DECLARE_PMID(kClassIDSpace, kPublishAdvancedPanelBoss,					kImportExportUIPrefix + 63)
...
//DECLARE_PMID(kImplementationIDSpace, kINXVersionDialogController, kImportExportUIPrefix + 9)
...
//DECLARE_PMID(kImplementationIDSpace, kINXVersionDialogObserverImpl, kImportExportUIPrefix + 15)
...
//DECLARE_PMID(kImplementationIDSpace, kPlaceSnippetTrackerImpl, kImportExportUIPrefix + 19)
...
DECLARE_PMID(kImplementationIDSpace, kPublishSelectableDialogCreatorImpl,				kImportExportUIPrefix + 129) 
DECLARE_PMID(kImplementationIDSpace, kPublishSelectableDialogObserverImpl,				kImportExportUIPrefix + 130) 
DECLARE_PMID(kImplementationIDSpace, kPublishGeneralPanelCreatorImpl,					kImportExportUIPrefix + 131) 
DECLARE_PMID(kImplementationIDSpace, kPublishGeneralPanelControllerImpl,				kImportExportUIPrefix + 132) 
DECLARE_PMID(kImplementationIDSpace, kPublishGeneralPanelObserverImpl,					kImportExportUIPrefix + 133) 
DECLARE_PMID(kImplementationIDSpace, kPublishImagePanelCreatorImpl,						kImportExportUIPrefix + 134) 
DECLARE_PMID(kImplementationIDSpace, kPublishImagePanelControllerImpl,					kImportExportUIPrefix + 135) 
DECLARE_PMID(kImplementationIDSpace, kPublishImagePanelObserverImpl,					kImportExportUIPrefix + 136)
DECLARE_PMID(kImplementationIDSpace, kPublishAdvancedPanelCreatorImpl,					kImportExportUIPrefix + 137) 
DECLARE_PMID(kImplementationIDSpace, kPublishAdvancedPanelControllerImpl,				kImportExportUIPrefix + 138) 
DECLARE_PMID(kImplementationIDSpace, kPublishAdvancedPanelObserverImpl,					kImportExportUIPrefix + 139)
...
// <Widget ID>
//    INX Version Panel
//DECLARE_PMID(kWidgetIDSpace, kINXVersionParentWidgetId,						kImportExportUIPrefix + 1)
//DECLARE_PMID(kWidgetIDSpace, kINXVersionGroupWidgetID,						kImportExportUIPrefix + 2)
//DECLARE_PMID(kWidgetIDSpace, kINXVersionTextWidgetID,						kImportExportUIPrefix + 3)
//DECLARE_PMID(kWidgetIDSpace, kINXVersionDropDownWidgetID,					kImportExportUIPrefix + 4)
...
//DECLARE_PMID(kWidgetIDSpace, kInDesignDocImportGeneralPanelGroupWidgetID,	kImportExportUIPrefix + 34)
//DECLARE_PMID(kWidgetIDSpace, k???WidgetID,								kImportExportUIPrefix + 35)
...
//DECLARE_PMID(kWidgetIDSpace, kInDesignDocImportGeneralPanelGroupWidgetID,	kImportExportUIPrefix + 41)
...
//DECLARE_PMID(kWidgetIDSpace, kIDDocLayersGenericPanel1WidgetID,				kImportExportUIPrefix + 55)
//DECLARE_PMID(kWidgetIDSpace, kIDDocLayersGenericPanel2WidgetID,				kImportExportUIPrefix + 56)
//DECLARE_PMID(kWidgetIDSpace, kIDDocLayersGenericPanel3WidgetID,				kImportExportUIPrefix + 57)
//DECLARE_PMID(kWidgetIDSpace, kIDDocLayersGenericPanel4WidgetID,				kImportExportUIPrefix + 58)
...
//DECLARE_PMID(kWidgetIDSpace, kPublishCoverImageDropdownWidgetID,			kImportExportUIPrefix + 78)
...
DECLARE_PMID(kWidgetIDSpace, kPublishCoverImageFilePathTextEditBoxWidgetID,	kImportExportUIPrefix + 106)
DECLARE_PMID(kWidgetIDSpace, kPublishFormatDropdownWidgetID,				kImportExportUIPrefix + 107)
...
DECLARE_PMID(kWidgetIDSpace, kPublishAdvancedPanelWidgetID,					kImportExportUIPrefix + 126)
...
DECLARE_PMID(kWidgetIDSpace, kPublishImageConversionDropdownWidgetID,		kImportExportUIPrefix + 153)
...
DECLARE_PMID(kWidgetIDSpace, kPublishSelDlgWidgetID,						kImportExportUIPrefix + 226)
DECLARE_PMID(kWidgetIDSpace, kPublishGeneralPanelWidgetID,					kImportExportUIPrefix + 227)
DECLARE_PMID(kWidgetIDSpace, kPublishAllRadioWidgetID,						kImportExportUIPrefix + 228)
DECLARE_PMID(kWidgetIDSpace, kPublishRangeRadioWidgetID,					kImportExportUIPrefix + 229)
DECLARE_PMID(kWidgetIDSpace, kPublishPageRangeTextEditBoxWidgetID,			kImportExportUIPrefix + 230)
//DECLARE_PMID(kWidgetIDSpace, kReaderCanDownloadID,							kImportExportUIPrefix + 231)
DECLARE_PMID(kWidgetIDSpace, kPublishLayoutSpreadsRadioWidgetID,			kImportExportUIPrefix + 232)
DECLARE_PMID(kWidgetIDSpace, kPublishCoverPanelWidgetID,					kImportExportUIPrefix + 233)
DECLARE_PMID(kWidgetIDSpace, kPublishCoverImageFileLocationPanelWidgetID,	kImportExportUIPrefix + 234)
DECLARE_PMID(kWidgetIDSpace, kPublishChooseCoverImageButtonWidgetID,		kImportExportUIPrefix + 235)
DECLARE_PMID(kWidgetIDSpace, kImageSettingsGroupTitleWidgetID,				kImportExportUIPrefix + 236)
DECLARE_PMID(kWidgetIDSpace, kPublishLayoutPagesRadioWidgetID,				kImportExportUIPrefix + 237)
...
DECLARE_PMID(kWidgetIDSpace, kPublishRasterizeChoosenPageRadioWidgetID,		kImportExportUIPrefix + 243)
DECLARE_PMID(kWidgetIDSpace, kPublishRasterizeFirstPageRadioWidgetID,		kImportExportUIPrefix + 244)
DECLARE_PMID(kWidgetIDSpace, kPublishChooseImageRadioWidgetID,				kImportExportUIPrefix + 245)
DECLARE_PMID(kWidgetIDSpace, kPublishAdvancedPanelCoverOptionsID,			kImportExportUIPrefix + 246)
DECLARE_PMID(kWidgetIDSpace, kPublishAdvancedPanelRasterCPOptionsID,		kImportExportUIPrefix + 247)
DECLARE_PMID(kWidgetIDSpace, kPublishRasterPageNumberWidgetID,				kImportExportUIPrefix + 248)
//DECLARE_PMID(kWidgetIDSpace, kPublishJPEGEncodingDropdownWidgetID,			kImportExportUIPrefix + 249)
DECLARE_PMID(kWidgetIDSpace, kPublishGIFPaletteDropdownWidgetID,			kImportExportUIPrefix + 250)
DECLARE_PMID(kWidgetIDSpace, kPublishJPEGQualityDropdownWidgetID,			kImportExportUIPrefix + 251)
//DECLARE_PMID(kWidgetIDSpace, kPublishGIFInterlaceCheckboxWidgetID,			kImportExportUIPrefix + 252)
DECLARE_PMID(kWidgetIDSpace, kPublishGIFGroupPanelWidgetID,					kImportExportUIPrefix + 253)
DECLARE_PMID(kWidgetIDSpace, kPublishJPEGGroupPanelWidgetID,				kImportExportUIPrefix + 254)
...
//DECLARE_PMID(kActionIDSpace, Unused, kImportExportUIPrefix + 9)
