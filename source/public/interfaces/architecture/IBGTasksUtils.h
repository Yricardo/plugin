//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/architecture/IBGTasksUtils.h $
//  
...
public:
	...
	*/
	virtual bool16  IsDocumentInUseByBGTasks( const UIDRef& documentRef ) const = 0;
	...
	*/
	virtual bool16  IsDataBaseInUseByBGTasks( IDataBase* db ) const = 0;
