//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/architecture/CommandID.h $
//  
//  Owner: Robin_Briggs
//  
//  $Author: gmatthew $
...
//DECLARE_PMID(kInterfaceIDSpace, IID_IUNUSED, kCommandPrefix + 37)
//DECLARE_PMID(kInterfaceIDSpace, IID_UNUSED, kCommandPrefix + 38)
