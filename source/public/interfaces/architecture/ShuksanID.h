//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/architecture/ShuksanID.h $
//  
//  Owner: Robin_Briggs
//  
//  $Author: devtecbj $
//  
//  $DateTime: 2015/04/09 23:37:23 $
//  
//  $Revision: #7 $
//  
//  $Change: 908083 $
...
DECLARE_PMID(kClassIDSpace, kControlSetDlgNameBoss, kShuksanPrefix + 115)
DECLARE_PMID(kClassIDSpace, kControlSetDlgElementBoss, kShuksanPrefix + 116)
DECLARE_PMID(kClassIDSpace, kCSDlgStaticTextBoss, kShuksanPrefix + 117)
...
//DECLARE_PMID(kInterfaceIDSpace, IID_IMYFANCYNEWINTERFACE, kShuksanPrefix + 235 )
...
DECLARE_PMID(kWidgetIDSpace, kControlSetDlgNameWidgetID, kShuksanPrefix + 89)
...
//DECLARE_PMID(kImplementationIDSpace, kNativeOpenFilterImpl, kShuksanPrefix + 135) // Moved to DocumentActionsID.h
...
DECLARE_PMID(kImplementationIDSpace, kControlSetDlgElementViewImpl, kShuksan2Prefix + 12)
...
DECLARE_PMID(kImplementationIDSpace, kCSDlgStaticTextViewImpl, kShuksan2Prefix + 16)
...
//DECLARE_PMID(kImplementationIDSpace, kMyFancyNewImpl, kShuksan2Prefix + 251 )
//DECLARE_PMID(kImplementationIDSpace, kMyFancyNewImpl, kShuksan2Prefix + 252 )
//DECLARE_PMID(kImplementationIDSpace, kMyFancyNewImpl, kShuksan2Prefix + 253 )
//DECLARE_PMID(kImplementationIDSpace, kMyFancyNewImpl, kShuksan2Prefix + 254 )
//DECLARE_PMID(kImplementationIDSpace, kMyFancyNewImpl, kShuksan2Prefix + 255 )
