//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/architecture/IObjectModel.h $
//  
//  Owner: Robin_Briggs
//  
//  $Author: gmatthew $
...
public:
	...
	//@{-----------------------------------------------------------------------------
		...
		// Register a new ID.
	virtual void RegisterID(PluginID ownerComponent, int32 IDSpaceID, char* name, int32 id) = 0;
