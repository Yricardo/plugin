//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/architecture/IM2MMessageListener.h $
//  
//  Owner: dwaterfa
//  
//  $Author: gmatthew $
	...
	*/
	...
	public:
		...
		*/
		...
		/**
		Copy constructor
		@param other Reference to ChangeData to copy from.
		*/
		ChangeData& operator=(const ChangeData& other)
			{
			fOriginalTargetRef = other.fOriginalTargetRef;
			fRelation = other.fRelation;
			fIID = other.fIID;
			return *this;
			}
