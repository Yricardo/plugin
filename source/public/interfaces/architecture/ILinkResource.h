//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/architecture/ILinkResource.h $
//  
...
public:
	...
	/**
	 Determines if the resource can be revealed by calling RevealInMiniBridge().
	 @return True if the resource can be revealed by calling RevealInMiniBridge(), else false.
	 */
	virtual bool CanRevealInMiniBridge() const = 0;
	
	/**
	 Reveals the resource.
	 @return kSuccess if the resource was revealed in Mini Bridge, else an error code.
	 */
	virtual ErrorCode RevealInMiniBridge() = 0;
