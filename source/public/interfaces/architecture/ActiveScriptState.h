//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/architecture/ActiveScriptState.h $
//  
...
{
public:
	ActiveScriptState(IScriptEngine* eng) : fEng(eng), fSuppressProgressBars(nil), fSuppressDialogs(kFalse)
	{
