//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/architecture/ILink.h $
//  
...
/**
 ...
 the link object to determine how to handle the confict.  For example, a naïve approach may
