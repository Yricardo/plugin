//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/graphics/IStructureMarks.h $
//  
	...
	public:
		...
		*/
		...
		/**
			...
			@return ErrorCode: Return kSuccess when successful.
		*/
		virtual ErrorCode BeginParagraph(ICompositionStyle *compositionStyle, IWaxLine *waxLine, IStyleInfo *styleInfo, IDrawingStyle *drawingStyle,
											IStructureMarks::ListType listType = IStructureMarks::kNone, int32 listLevel = 0) = 0;
		...
		*/
		...
		/**
			...
			There are matching BeginReference and EndReference calls.
			@return ErrorCode: Return kSuccess when successful. 
		*/
		...
		*/
		...
		/**
			...
			@param TextIndex textIndex: The text index of the anchor marker in the containing story.
			@return ErrorCode: Return kSuccess when successful.
		*/
		virtual ErrorCode AnchoredObjectMarker(TextIndex textIndex) = 0;

		/**
			This method is called at the beginning of exporting a hyperlink inside table cell.
			@return ErrorCode: Return kSuccess when successful. 
		*/
