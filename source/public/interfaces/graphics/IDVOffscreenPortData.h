//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/graphics/IDVOffscreenPortData.h $
//  
//  Owner: Deepak Gupta
//  
//  $Author: devtecbj $
//  
//  $DateTime: 2014/03/20 00:36:54 $
//  
//  $Revision: #3 $
//  
//  $Change: 872831 $
...
public: 
	...
	*/ 
	...
	@param bitmap 
	*/ 
	virtual void SetTargetBitmap(IDVPlatformOffscreen* bitmap) = 0; 
