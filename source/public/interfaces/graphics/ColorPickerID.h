//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/graphics/ColorPickerID.h $
//  
//  Owner: SusanCL
//  
//  $Author: devtecbj $
...
DECLARE_PMID(kWidgetIDSpace, kSpectrumHiliteBorderWidgetId, kColorPickerPrefix + 80)
...
DECLARE_PMID(kServiceIDSpace, kReallyBogusPanelService, kColorPickerPrefix + 3)
