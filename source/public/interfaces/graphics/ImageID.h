//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/graphics/ImageID.h $
//  
//  Owner: jargast
//  
//  $Author: gmatthew $
...
DECLARE_PMID(kClassIDSpace, kLinkInfoXMPApertureProviderImpl, kImagePrefix + 158)
DECLARE_PMID(kClassIDSpace, kLinkInfoXMPKeywordsProviderImpl, kImagePrefix + 159)
DECLARE_PMID(kClassIDSpace, kLinkInfoXMPISOSpeedProviderImpl, kImagePrefix + 160)
DECLARE_PMID(kClassIDSpace, kLinkInfoXMPCameraProviderImpl, kImagePrefix + 161)
DECLARE_PMID(kClassIDSpace, kLinkInfoXMPShutterProviderImpl, kImagePrefix + 162)
DECLARE_PMID(kClassIDSpace, kLinkInfoXMPFocalLengthProviderImpl, kImagePrefix + 163)
DECLARE_PMID(kClassIDSpace, kLinkInfoXMPLensProviderImpl, kImagePrefix + 164)
DECLARE_PMID(kClassIDSpace, kLinkInfoXMPCaptureDateProviderImpl, kImagePrefix + 165)
DECLARE_PMID(kClassIDSpace, kLinkInfoXMPRatingProviderImpl, kImagePrefix + 166)
DECLARE_PMID(kClassIDSpace, kLinkInfoUsedSwatchesProviderImpl, kImagePrefix + 167)
DECLARE_PMID(kClassIDSpace, kLinkInfoXMPCreditProviderImpl, kImagePrefix + 168)
DECLARE_PMID(kClassIDSpace, kLinkInfoXMPDescriptionProviderImpl, kImagePrefix + 169)
DECLARE_PMID(kClassIDSpace, kLinkInfoXMPHeadlineProviderImpl, kImagePrefix + 170)
DECLARE_PMID(kClassIDSpace, kLinkInfoXMPLocationProviderImpl, kImagePrefix + 171)
DECLARE_PMID(kClassIDSpace, kLinkInfoXMPLocationCityProviderImpl, kImagePrefix + 172)
DECLARE_PMID(kClassIDSpace, kLinkInfoXMPLocationStateProviderImpl, kImagePrefix + 173)
DECLARE_PMID(kClassIDSpace, kLinkInfoXMPLocationCountryProviderImpl, kImagePrefix + 174)
