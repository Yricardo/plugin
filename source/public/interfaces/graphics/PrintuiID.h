//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/graphics/PrintuiID.h $
//  
...
DECLARE_PMID(kImplementationIDSpace, kProxyTextControlDataImpl, kPrintUIPrefix + 145)
DECLARE_PMID(kImplementationIDSpace, kProxyCustomControlViewImpl, kPrintUIPrefix + 146)
DECLARE_PMID(kImplementationIDSpace, kProxyCustomControlDataImpl, kPrintUIPrefix + 147)
DECLARE_PMID(kImplementationIDSpace, kProxyPanelEventHandlerImpl, kPrintUIPrefix + 148)
