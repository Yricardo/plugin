//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/ui/IWindow.h $
//  
//  Owner: Robin_Briggs
//  
//  $Author: gmatthew $
	...
	enum WindowSpec{ 
		...
		*/
		...
		/**  Standard controls based on specified frame and layer. Here's a list of what the standard controls are for various window frames:
				¥ for windows with kNoWindowFrame, kStandardWindowControls ==> kNoWindowControls
				¥ otherwise for kDocWindowFrame windows, kStandardWindowControls ==> kStandardDocWindowControls 
				¥ otherwise for kPaletteWindowFrame windows, kStandardWindowControls ==> kStandardPaletteWindowControls
				¥ otherwise for kModelessDialogWindowFrame windows, kStandardWindowControls ==> kCloseWindowControl
				¥ otherwise kStandardWindowControls ==> kNoWindowControls 
		*/
