//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/ui/IActionManager.h $
//  
//  Owner: lance bushore
//  
//  $Author: gmatthew $
...
#ifdef DEBUG
		typedef enum { enablingInfo, customEnableInfo, nonEditableInfo, allActionInfo, prePostNotifyInfo, actionNameInfo } ActionInfoType;
