//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/ui/DV_WidgetID.h $
//  
//  Owner: Dave Burnard
//  
//  $Author: devtecbj $
...
DECLARE_PMID(kImplementationIDSpace, kDV_WindowRootPanelViewImpl,				kDV_WidgetPrefix + 43)
