//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/layout/IPackageReport.h $
//  
//  Owner: KenS
//  
//  $Author: gmatthew $
...
{
public:
  virtual bool16 GenerateReport( IS4SPPackage* pPackage, IDFile* overridden = NULL, bool16 showCAlert = kTrue ) = 0;
  virtual bool16 GenerateReport( IS4SPPackageBook* pPackage, IDFile* overridden = NULL, bool16 showCAlert = kTrue ) = 0;
};
