//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/layout/EyeDropperToolID.h $
//  
//  Owner: Dave Stephens
//  
//  $Author: devtecbj $
//  
//  $DateTime: 2015/04/22 23:35:56 $
//  
//  $Revision: #5 $
//  
//  $Change: 909508 $
...
DECLARE_PMID(kClassIDSpace, kEyeDropperToggleToolActionBoss, kEyeDropperToolPrefix + 4) 
//gap
...
DECLARE_PMID(kImplementationIDSpace, kEyeDropperToggleToolActionImpl, kEyeDropperToolPrefix + 209)
DECLARE_PMID(kImplementationIDSpace, kEyeDropperToolTipImpl, kEyeDropperToolPrefix + 210)
...
DECLARE_PMID(kWidgetIDSpace, kParaBorderShadingCheckBoxWidgetId, kEyeDropperToolPrefix + 69)
...
// <Action ID>
// Action IDs
DECLARE_PMID(kActionIDSpace, kToggleEyeDropperModeActionID, kEyeDropperToolPrefix + 1) 
