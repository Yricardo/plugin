//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/layout/LayoutUIID.h $
//  
//  Owner: Robin_Briggs
//  
//  $Author: devtecbj $
...
DECLARE_PMID(kClassIDSpace, kDocStatusBarCloudSyncButtonBoss, kLayoutUIPrefix + 178)
DECLARE_PMID(kClassIDSpace, kSyncToCloudPopupDialogBoss, kLayoutUIPrefix + 179)
DECLARE_PMID(kClassIDSpace, kSyncToCloudPanelWindowBoss, kLayoutUIPrefix + 180)
DECLARE_PMID(kClassIDSpace, kSyncPanelEventOverrideBoss, kLayoutUIPrefix + 181)
DECLARE_PMID(kClassIDSpace, kShareOnBehanceButtonBoss, kLayoutUIPrefix + 182)
...
DECLARE_PMID(kInterfaceIDSpace, IID_ISYNCTOCLOUDPOPUPMGR, kLayoutUIPrefix + 93)
...
DECLARE_PMID(kImplementationIDSpace, kBehanceIconButtonObserverImpl, kLayoutUI2Prefix + 57)
...
DECLARE_PMID(kImplementationIDSpace, kCloudSyncStatusButtonObserverImpl,	kLayoutUI2Prefix + 108)
DECLARE_PMID(kImplementationIDSpace, kCloudSyncStatusButtonTipImpl,	kLayoutUI2Prefix + 109)
DECLARE_PMID(kImplementationIDSpace, kSyncSettingsPopupPanelWidgetAttributesImpl,	kLayoutUI2Prefix + 110)
DECLARE_PMID(kImplementationIDSpace, kSyncToCloudPopupPanelViewImpl,	kLayoutUI2Prefix + 111)
DECLARE_PMID(kImplementationIDSpace, kSyncToCloudPopupObserverImpl,	kLayoutUI2Prefix + 112)
DECLARE_PMID(kImplementationIDSpace, kSyncToCloudPanelWindowImpl,	kLayoutUI2Prefix + 113)
DECLARE_PMID(kImplementationIDSpace, kSyncPanelTopEHImpl,	kLayoutUI2Prefix + 114)
DECLARE_PMID(kImplementationIDSpace, kSyncToCloudPopupMgrImpl,	kLayoutUI2Prefix + 116)
DECLARE_PMID(kImplementationIDSpace, kCloudSyncStatusButtonViewImpl,	kLayoutUI2Prefix + 117)
...
DECLARE_PMID(kWidgetIDSpace, kSyncSettingsPopupPanelParentWidgetId, kLayoutUIPrefix + 134)
DECLARE_PMID(kWidgetIDSpace, kRow1EmailTextWidgetID, kLayoutUIPrefix + 135)
DECLARE_PMID(kWidgetIDSpace, kRow2LastSyncTextWidgetID, kLayoutUIPrefix + 136)
DECLARE_PMID(kWidgetIDSpace, kSyncNowBtnWidgetID, kLayoutUIPrefix + 137)
DECLARE_PMID(kWidgetIDSpace, kRemeberPrefCheckBoxWidgetID, kLayoutUIPrefix + 138)
DECLARE_PMID(kWidgetIDSpace, kRow3PanelWidgetId, kLayoutUIPrefix + 139)
DECLARE_PMID(kWidgetIDSpace, kSyncingWidgetId, kLayoutUIPrefix + 140)
DECLARE_PMID(kWidgetIDSpace, kPauseBtnWidgetID, kLayoutUIPrefix + 141)
DECLARE_PMID(kWidgetIDSpace, kApplyNowStatePanelWidgetId, kLayoutUIPrefix + 142)
DECLARE_PMID(kWidgetIDSpace, kApplySettingsTextWidgetId, kLayoutUIPrefix + 143)
DECLARE_PMID(kWidgetIDSpace, kApplyBtnWidgetID, kLayoutUIPrefix + 144)
DECLARE_PMID(kWidgetIDSpace, kSyncProgressBarWidgetID, kLayoutUIPrefix + 145)
DECLARE_PMID(kWidgetIDSpace, kSyncNowBtnPanelWidgetID, kLayoutUIPrefix + 146)
DECLARE_PMID(kWidgetIDSpace, kPauseBtnPanelWidgetID, kLayoutUIPrefix + 147)
DECLARE_PMID(kWidgetIDSpace, kBehanceButtonWidgetID, kLayoutUIPrefix + 148)
...
DECLARE_PMID(kActionIDSpace, kDocStatusRevealInMiniBridgeActionID, kLayoutUIPrefix + 82)
