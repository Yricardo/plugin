//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/tables/ITablePageItemContent.h $
//  
//  Owner: Rahul Jain
//  
//  $Author: devtecbj $
...
public:
	...
	*/
	...
	@return UIDRef	List of UIDRef of all objects placed in the graphic cells of the specified area. 
