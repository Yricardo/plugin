//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/text/ITextParcelList.h $
//  
//  Owner: dwaterfa
//  
//  $Author: devtecbj $
//  
//  $DateTime: 2014/03/19 00:53:59 $
//  
//  $Revision: #3 $
//  
//  $Change: 872559 $
...
class ITextParcelList : public IPMUnknown
{
	public:
		...
		*/
		...
		virtual void		DamageEntireParcel(ParcelKey key) = 0;
		virtual void		DamageEntireParcelP1(ParcelKey key) = 0;
		...
		*/
		...
		virtual void		Damage(ComputeMethod1, ParcelKey key) = 0;
