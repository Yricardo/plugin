//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/text/ILanguage.h $
//  
//  Owner: Bernd Paradies
//  
//  $Author: devtecbj $
//  
//  $DateTime: 2015/04/07 23:38:03 $
//  
//  $Revision: #2 $
//  
//  $Change: 907839 $
...
public:
	...
	*/
	virtual const U_ICU_NAMESPACE::Locale&		GetICULocale() const = 0;
	...
	*/
	virtual void			SetICULocale(const U_ICU_NAMESPACE::Locale &newLocale) = 0;
