//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/text/TextEditorID.h $
//  
...
//DECLARE_PMID(kClassIDSpace, kFancyNameBoss, kTextEditorPrefix + 76 )
//DECLARE_PMID(kClassIDSpace, kFancyNameBoss, kTextEditorPrefix + 77 )
//DECLARE_PMID(kClassIDSpace, kFancyNameBoss, kTextEditorPrefix + 78 )
//DECLARE_PMID(kClassIDSpace, kFancyNameBoss, kTextEditorPrefix + 79 )
//DECLARE_PMID(kClassIDSpace, kFancyNameBoss, kTextEditorPrefix + 80 )
//DECLARE_PMID(kClassIDSpace, kFancyNameBoss, kTextEditorPrefix + 81 )
//DECLARE_PMID(kClassIDSpace, kFancyNameBoss, kTextEditorPrefix + 82 )
//DECLARE_PMID(kClassIDSpace, kFancyNameBoss, kTextEditorPrefix + 83 )
//DECLARE_PMID(kClassIDSpace, kFancyNameBoss, kTextEditorPrefix + 84 )
...
//DECLARE_PMID(kClassIDSpace, kFancyNameBoss, kTextEditorPrefix + 99 )
...
//DECLARE_PMID(kClassIDSpace, kFancyNameBoss, kTextEditorPrefix + 248 )
//DECLARE_PMID(kClassIDSpace, kFancyNameBoss, kTextEditorPrefix + 249 )
...
//DECLARE_PMID(kClassIDSpace, kFancyNameBoss, kTextEditorPrefix + 252 )
//DECLARE_PMID(kClassIDSpace, kFancyNameBoss, kTextEditorPrefix + 253 )
...
//DECLARE_PMID(kInterfaceIDSpace, IID_IFANCYNAME, kTextEditorPrefix + 29 )
//DECLARE_PMID(kInterfaceIDSpace, IID_IFANCYNAME, kTextEditorPrefix + 30 )
//DECLARE_PMID(kInterfaceIDSpace, IID_IFANCYNAME, kTextEditorPrefix + 31 )
//DECLARE_PMID(kInterfaceIDSpace, IID_IFANCYNAME, kTextEditorPrefix + 32 )
//DECLARE_PMID(kInterfaceIDSpace, IID_IFANCYNAME, kTextEditorPrefix + 33 )
//DECLARE_PMID(kInterfaceIDSpace, IID_IFANCYNAME, kTextEditorPrefix + 34 )
...
//DECLARE_PMID(kInterfaceIDSpace, IID_IFANCYNAME, kTextEditorPrefix + 252 )
