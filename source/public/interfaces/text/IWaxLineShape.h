//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/text/IWaxLineShape.h $
//  
//  Owner: zwilliam
//  
//  $Author: devtecbj $
...
public:
	...
	*/
	...
	/** Invalidate cached information (if any) held by this interface with the aim that subsequent calls to this interface will
		(automatically and silently) re-compute the original data.

		@note that this does NOT cause screen inval with WaxLine::Inval()
	*/
	virtual void InvalCachedData() = 0;

	/** Return whether or not this object has cached InkBounds and PassInfo. */
