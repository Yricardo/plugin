//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/text/IWaxStrand.h $
//  
//  Owner: zwilliam
//  
//  $Author: gmatthew $
...
public:
	...
	virtual void MarkGeometryDamage(TextIndex start, int32 length,
					...
					TreatAsOverset treatAsOverset = kDontTreatAsOverset) = 0;
	...
	*/
	...
	struct CallbackWaxIteratorData
	{
		...
		CallbackWaxIteratorData() :
				prevInvalid(kFalse), prevSelectionBottom(0.), prevSelectionTop(0.),
				thisSelectionTop(0.), thisSelectionBottom(0.),
				nextInvalid(kFalse), nextSelectionTop(0.),
				waxLine(nil), localOffset(0)
			{ }
	};
