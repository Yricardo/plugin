//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/text/FontUsageDialogID.h $
//  
//  Owner: lance bushore
//  
//  $Author: devtecbj $
...
DECLARE_PMID(kClassIDSpace, kMissingFontListScrollerWidgetBoss, kFontUsagePrefix + 15)
...
// ---- end move.
DECLARE_PMID(kImplementationIDSpace, kMissingFontNodeControlViewImpl, kFontUsagePrefix + 19)
DECLARE_PMID(kImplementationIDSpace, kMissingFontTreeScrollerWidgetViewImpl, kFontUsagePrefix + 20)
