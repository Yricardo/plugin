//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/text/TextPanelID.h $
//  
//  Owner: Bernd Paradies
//  
//  $Author: devtecbj $
//  
//  $DateTime: 2013/09/02 23:38:18 $
//  
//  $Revision: #2 $
//  
//  $Change: 857867 $
...
// DONT USE THE IDS 3808-3828 they are reserved for separators of the fonts
...
#else
DECLARE_PMID(kActionIDSpace, kLastFontSepActionID, kTextPanelPrefix +3828			/* last font separator */)
#endif
