//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/text/ICompositionStyle.h $
//  
//  Owner: EricM
//  
//  $Author: devtecbj $
...
class ICompositionStyle : public IPMUnknown
{
	public:
		...
		/** Left to Right / Left to Right paragraph direction */
		...
		/** ParagraphBorderShadingBottomOrigin. */
