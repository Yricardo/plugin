//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/text/IWalkerScopeFactoryUtils.h $
//  
...
public:
	 ...
	 */
	virtual ITextWalkerScope *QueryFocusListWalkerScope(const ITextFocusList* focusList,WalkerScopeOptions options = WalkerScopeOptions()) const = 0;
