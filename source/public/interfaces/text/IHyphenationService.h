//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/text/IHyphenationService.h $
//  
...
public:
	 ...
	 */
	virtual	IHyphenatedWord*	Hyphenate(const TextCharBuffer &rWord, LinguisticServiceMode hyphenMode, uint16 nMinTail = 0, uint16 nMinHead = 0) = 0;
