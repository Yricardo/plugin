//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/text/ITextAdornment.h $
//  
//  Owner: dwaterfa
//  
//  $Author: devtecbj $
...
#define kTAPriParagraphBorderShade		Text::DrawPriority(Text::kTAPassPriBackground + -0.61)			// BEFORE para rules
