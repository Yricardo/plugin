//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/interfaces/text/TextStylePanelID.h $
//  
...
#define kTextStyleParaCoreDialogRsrcID 	1350
#define kTextStyleCharCoreDialogRsrcID 	1400
...
DECLARE_PMID(kClassIDSpace, kTextStyleParaCoreDialogHookBoss, kTextStylePanelPrefix + 250)
DECLARE_PMID(kClassIDSpace, kTextStyleCharCoreDialogHookBoss, kTextStylePanelPrefix + 251)
...
DECLARE_PMID(kImplementationIDSpace, kTextStyleParaCoreDialogRsrcData, kTextStylePanelPrefix + 122) /* returns kTextStyleParaCoreDialogRsrcID */
DECLARE_PMID(kImplementationIDSpace, kTextStyleCharCoreDialogRsrcData, kTextStylePanelPrefix + 123) /* returns kTextStyleCharCoreDialogRsrcID */
...
DECLARE_PMID(kWidgetIDSpace, kAddStyleToCCLibrariesCheckboxWidgetID, kTextStylePanelPrefix + 118)
DECLARE_PMID(kWidgetIDSpace, kAddStyleToCCLibrariesPanelWidgetID, kTextStylePanelPrefix + 119)
DECLARE_PMID(kWidgetIDSpace, kStylePluginCCLibraryDropdownWidgetID, kTextStylePanelPrefix + 120)
