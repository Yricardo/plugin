//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/open/includes/widgets/DVPanelControlData.h $
//  
//  Owner: Dave Burnard
//  
//  $Author: gmatthew $
...
protected:
	void					AddToWidgetList(IControlView* view, int32 at = -1, bool16 invalidate = kTrue);
