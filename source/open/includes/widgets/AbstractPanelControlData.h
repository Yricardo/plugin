//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/open/includes/widgets/AbstractPanelControlData.h $
//  
...
protected:
	void					ChangeWidgetParent(IPMUnknown* newParent, IControlView *widget);
