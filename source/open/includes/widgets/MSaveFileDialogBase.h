//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/open/includes/widgets/MSaveFileDialogBase.h $
//  
//  Owner: Lin Xia
//  
//  $Author: devtecbj $
...
class WIDGET_DECL MSaveFileDialogBase : public ISaveFileDialog
{
	public:
		...
		void ExtensionSelectionChange(NSInteger extIndex);
	...
	protected:
		...
		*/
		...
		virtual void HandleExtensionSelectionChange(NSInteger extIndex);
