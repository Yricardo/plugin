//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/open/includes/widgets/WSaveFileDialogBase.h $
//  
//  Owner: Lin Xia
//  
//  $Author: devtecbj $
...
class WIDGET_DECL WSaveFileDialogBase : public ISaveFileDialog
{
	...
	protected:
		...
		virtual void PostDoDialog(bool16& dlgResult, IDFile *resutlFile);			// no-op by default
