//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/open/includes/architecture/k2sortedvector.h $
//  
//  Owner: Mat Marcus
//  
//  $Author: gmatthew $
...
public:
	...
	// construction and assignment
							K2SortedVector() 										{}
	explicit 				K2SortedVector(int32 cap) 				: fVector(cap) 	{}
							K2SortedVector(const K2SortedVector& rhs) 	: fVector(rhs.fVector) 	{}
