//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/open/includes/architecture/k2sortedlookup.h $
//  
//  Owner: EricM
//  
//  $Author: gmatthew $
...
class K2SortedLookup
{
	public:
		K2SortedLookup()
			{}
		K2SortedLookup(int32 chunkSize) :fKeyList(chunkSize), fValueList(chunkSize)
			{}
