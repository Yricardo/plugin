//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/open/components/buttonui/appearancepanel/AppearancePanelObserver.cpp $
//  
	...
	case kNameEditWID:
		...
		if (iFormSuite)
		{
			...
			if (!iEdit->GetString().IsEmpty())
			{
				if ( iAppearanceSuite )
				{
					if (iAppearanceSuite->SetName(iEdit->GetString()) != kSuccess )
					{
