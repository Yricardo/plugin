//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/open/components/buttonui/hacks/FormFieldUIFactoryList.h $
//  
...
//========================================================================================
	...
	REGISTER_PMINTERFACE(MSOPanelStateNameILEController, kMSOPanelStateNameILEControllerImpl)
	...
	REGISTER_PMINTERFACE(ButtonPDFOptionsDialogController, kButtonPDFOptionsDialogControllerImpl)
