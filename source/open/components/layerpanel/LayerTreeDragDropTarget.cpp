//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/open/components/layerpanel/LayerTreeDragDropTarget.cpp $
//  
//  Owner: Yeming Liu
//  
//  $Author: devtecbj $
...
void	LayerTreeDragDropTarget::AdjustHiliteLine( IControlView*	widget, PMReal& left, PMReal&  /*right*/)
{
	...
	if(uidNode->IsLayerEntry())
	{
		...
		left = nameWidget->GetFrame().Left();
	}
	else
	{
		IControlView * nameWidget = panelData->FindWidget(kLayerPageItemNamePanelWidgetID);
		left = nameWidget->GetFrame().Left() + 14;
	}
}
