//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/open/components/linksui/LinkThumbnailView.cpp $
//  
//  Owner: lance bushore
//  
//  $Author: gmatthew $
...
void LinkThumbnailView::DrawThumbnail( IGraphicsPort* gPort, const PMRect &frame )
{
	...
	if(iImageCache)
		Utils<IThumbnailUtils>()->DrawImageThumbnail(gPort,iImageCache,frame);
	else
	{
