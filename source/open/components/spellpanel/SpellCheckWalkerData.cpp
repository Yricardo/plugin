//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/open/components/spellpanel/SpellCheckWalkerData.cpp $
//  
		...
		TextIndex *pErrorStart, TextIndex *pErrorEnd )
{
	...
	*pErrorEnd = *pErrorStart + nErrorHighlightLength;
	...
	while (UnicodeClass::IsIgnoredCharacter(aParagraph.GetChar(nParaErrorStart + (*pErrorEnd - *pErrorStart))))
	{
		(*pErrorEnd)++;
	}
