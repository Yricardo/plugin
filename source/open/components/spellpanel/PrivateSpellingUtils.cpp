//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/open/components/spellpanel/PrivateSpellingUtils.cpp $
//  
//  Owner: hhorton
//  
//  $Author: devtecbj $
//  
//  $DateTime: 2015/05/26 08:26:57 $
//  
//  $Revision: #2 $
//  
//  $Change: 913196 $
			...
			while (presentationIter != presentationList.end())
			{
				...
				else	/* layout view */
				{
					if (*presentationIter)
					{
						...
						if (panelData)
						{
							IControlView* iDocView = panelData->FindWidget (kLayoutWidgetBoss);
							if (iDocView)
							{
