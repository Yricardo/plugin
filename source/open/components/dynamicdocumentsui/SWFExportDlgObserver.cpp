//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/open/components/dynamicdocumentsui/SWFExportDlgObserver.cpp $
//  
//  Owner: DBerggren
//  
//  $Author: devtecbj $
...
protected: 
	...
	IControlView* CreateInitFontWidget(const PMString& fontString, bool16 isMissing, bool16 isGraphic,PMReal listboxWidth, IPMFont::FontType fontType, bool16 isTKDFont);
...
void SWFExportDlgObserver::RebuildFontList()
{
	...
	for(int32 j = 0; j < docFonts->GetNumUsedFonts(); j++)
	{
		...
		InterfacePtr<IControlView> fontView(CreateInitFontWidget(fontString,kFalse,kFalse,listboxWidth,fontType, isTKDFont));
...
IControlView* SWFExportDlgObserver::CreateInitFontWidget( const PMString& fontString, bool16 isMissing, bool16 isGraphic,PMReal listboxWidth, IPMFont::FontType fontType, bool16 isTKDFont )
{
	...
	PMRect rightIconFrame (listboxWidth-20.0, 0.0, listboxWidth-6.0,  14.0);
	PMRect graphicIconFrame(listboxWidth-40.0, 0.0, listboxWidth-20.0, 14.0);
	PMRect missingIconFrame(listboxWidth-40.0 - isGraphic*18.0, 0.0, listboxWidth-26.0 - isGraphic*18.0, 14.0);
