//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/open/components/dynamicdocumentsui/PageTransitionsDialogController.cpp $
//  
//  Owner: Yeming Liu
//  
//  $Author: gmatthew $
    ...
    if (panelData)
    {
        for (int32 i = 0; i < panelData->Length(); i++)
        {
			...
			if (iAssociatedPageTransitionClassID)
			{
				...
				if (containerWidgetIDList.Location(containerWidgetID) < 0)
