//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/open/components/dynamicdocumentsui/DynamicDocumentsUIUtils.cpp $
//  
//  Owner: DBerggren
//  
//  $Author: devtecbj $
	...
	bool const isHilite, bool16 const bIsFirstItemInGroup, bool16 const bIsLastItemInGroup)
{
	...
	PMPointList pathPtsV(2);
	PMPointList pathPtsH(2);	
...
{ 			
	...
	PMReal panelWidth = kAnimationUIPanelMinWidth;
	...
	PMPoint newDimension (panelWidth, panelHeight);

	PMPoint delta(panelWidth - panelFrame.Width(), panelHeight - panelFrame.Height());
