//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/sdksamples/chmlfilter/CHMLFiltTextHelper.cpp $
//  
...
void CHMLFiltTextHelper::AddFont(const PMString& name)
{
	do {
			...
			(!isPlatSupFont)||((isPlatSupFont->GetFontStatus() & IPMFont::kFontNotAvailable) != 0)))
		{
			...
			TRACEFLOW("CHMLFilter", "Missing font in CHMLFiltTextHelper::AddFont(%s)", name.GetPlatformString().c_str());
			break;
		}
