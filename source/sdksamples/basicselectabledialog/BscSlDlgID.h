//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/sdksamples/basicselectabledialog/BscSlDlgID.h $
//  
...
#define kBscSlDlgPrefixNumber	0x48400 	// Unique prefix number for this plug-in(*Must* be obtained from Adobe Developer Support).
