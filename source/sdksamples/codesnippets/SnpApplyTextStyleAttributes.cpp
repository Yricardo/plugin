//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/sdksamples/codesnippets/SnpApplyTextStyleAttributes.cpp $
//  
//  Owner: Adobe Developer Technologies
//  
//  $Author: devtecbj $
//  
//  $DateTime: 2013/07/16 06:32:48 $
//  
//  $Revision: #2 $
//  
//  $Change: 854521 $
...
ErrorCode _SnpRunnerApplyTextStyleAttributes::Run(ISnpRunnableContext* runnableContext)
{
	...
	do {		
		...
		enum {
				...
				kCreateParagraphStyle, kApplyParaStyle, kCreateCharStyle, kApplyCharacterStyle, kCharacterRotate, kSetParagraphLayout, 
				// InDesign Japanese Features
