//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/sdksamples/codesnippets/SnpExportBookAsPDF.cpp $
//  
...
ErrorCode _SnpRunnerExportBookAsPDF::Run(ISnpRunnableContext* runnableContext)
{
	...
	do {
		...
		int32 pdfExportStyleLength = pdfExportStyles.Length();
		if (pdfExportStyleLength > 0)
		{
			if (defaultPDFExportStyle < 0 || defaultPDFExportStyle >= pdfExportStyleLength)
			{
