//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/sdksamples/codesnippets/SnpInspectLayoutModel.cpp $
//  
	...
	public:
		...
		*/
		...
		//@{
			...
			static void			TraceLayerName(char* msg, IHierarchy* spreadLayer);
...
/*
*/
void SnpInspectLayoutModel::TraceLayerName(char* msg, IHierarchy* node)
{
	PMString layerName;
