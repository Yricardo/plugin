//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/sdksamples/codesnippets/SnpInspectLayoutGrid.cpp $
//  
...
ErrorCode SnpInspectLayoutGrid::InspectLayoutGrid(const UIDRef& thePage, SnpLayoutGridInfo& info)
{
	...
	do 
	{
		...
		*/
		...
		if (font == nil)
		{
			ASSERT_FAIL(FORMAT_ARGS("Cannot find font with style '%s'", info.fFontStyleName.GetPlatformString().c_str()));
			break;
		}
