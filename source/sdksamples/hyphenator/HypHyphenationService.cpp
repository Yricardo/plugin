//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/sdksamples/hyphenator/HypHyphenationService.cpp $
//  
...
class HypHyphenationService : public CPMUnknown<IHyphenationService>
{
	...
	public:
		 ...
		 */
		virtual	IHyphenatedWord*	Hyphenate(const TextCharBuffer& rWord, LinguisticServiceMode mode, uint16 nMinTail, uint16 nMinHead);
...
/*
*/
IHyphenatedWord* HypHyphenationService::Hyphenate(const TextCharBuffer& rWord, LinguisticServiceMode serviceMode, uint16 nMinTail, uint16 nMinHead)
{
