//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/sdksamples/csxsdemo/VDID.h $
//  
...
#define kVDPrefixNumber	0xe9900 		// Unique prefix number for this plug-in(*Must* be obtained from Adobe Developer Support).
