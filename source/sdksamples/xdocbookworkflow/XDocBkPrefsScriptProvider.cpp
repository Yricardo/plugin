//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/sdksamples/xdocbookworkflow/XDocBkPrefsScriptProvider.cpp $
//  
		...
		if(data->IsPropertyPut())
		{
			switch(propID.Get())
			{
				case p_XDocSetOption:
				{
					...
					K2Vector<ScriptData>::const_iterator iter;
					for (iter = dataList.begin(); iter != dataList.end(); ++iter)
					{
						WideString templatePath;
						(*iter).GetWideString(templatePath);
