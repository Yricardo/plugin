//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/sdksamples/scriptingcomms/SCID.h $
//  
...
#define kSCPrefixNumber	0xe9670 		// Unique prefix number for this plug-in(*Must* be obtained from Adobe Developer Support).
