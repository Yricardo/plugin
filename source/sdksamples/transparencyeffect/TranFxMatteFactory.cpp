//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/sdksamples/transparencyeffect/TranFxMatteFactory.cpp $
//  
...
void TranFxMatteFactory::AddToCache(const AGMImageAccessor* mattRec, uint32 startTime, const UIDRef& uidRef, const PMReal& resolution, uint32 checksum) 
{
	do
	{
		...
		imageCache->Init(const_cast<AGMImageAccessor*>(mattRec), ::ToUInt32(resolution), ::TickCount() - startTime, checksum);
