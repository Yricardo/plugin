//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/sdksamples/codesnippetsME/SnpApplyMEAttributes.cpp $
//  
...
bool16	SnpApplyMEAttributes::CanRun(ISnpRunnableContext* runnableContext)
{
	...
	do {
        ...
        if (composerClass != kOptycaParagraphComposerBoss && 
            composerClass != kOptycaSingleComposerBoss) 
        { 
            break; 
        } 
		result = kTrue;
