//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/sdksamples/chlinguistic/CHLUserDict.cpp $
//  
...
{
	ASSERT(oldIndex <= fUserDictList.Length() && oldIndex >= 0);
	ASSERT(newIndex <= fUserDictList.Length());

	if ((oldIndex > fUserDictList.Length() || oldIndex < 0) || newIndex > fUserDictList.Length())
		return kFalse;
