//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/sdksamples/chlinguistic/CHLUserDictContentHandler.cpp $
//  
	...
	if (localname == WideString("wordlist"))
	{
		...
		if (userDict)
		{
			...
			if (chlUserDict)
			{
				...
				for (int32 i = 0; i < fStringList.Length(); i++)
				{
					udWordList.InsertUnique(fStringList[i]);
				}
