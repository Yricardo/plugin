//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/sdksamples/xdocbookworkflowui/XDocBkUIDialogController.cpp $
//  
...
void XDocBkUIDialogController::ApplyDialogFields(IActiveContext* myContext, const WidgetID& widgetId) 
{
	...
	do
	{
		...
		K2Vector<WideString> optionsVec(cXDocBkOptionCardinality);
