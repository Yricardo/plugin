//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/private/interfaces/testing/IQAMessageUtils.h $
//  
...
class IQAMessageUtils : public IPMUnknown
{
	...
	public:
		...
		virtual	void	LogString( PMString formattingInfo, char* formatstring, ...) = 0;
		
		virtual	void	ErrorAssert( bool16 condition, char* formatstring, ...) = 0;
		virtual	void	WarningAssert( bool16 condition, char* formatstring, ...) = 0;
		virtual	void	FatalErrorAssert( bool16 condition, char* formatstring, ...) = 0;
		...
		virtual void		PushMessageHeader(char* formatstring, ...) = 0;
