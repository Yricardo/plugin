//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/components/testing/aat/includes/AcquisitionElements.h $
//  
//  Owner: robin briggs
//  
//  $Author: devtecbj $
...
class AATLIB_DECL AcquisitionElement : public VAcquisitionElement
{
	public:
		...
		virtual ProdInt32		GetNumValues(void) { return fValues.Length(); }
		...
		virtual ProdInt32	GetNumToolTips(void) { return fTipText.Length(); }
