//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/components/testing/aat/includes/AATDataTypes.h $
//  
//  Owner: Gregor Kaplan
//  
//  $Author: devtecbj $
...
{ \
	public: \
		...
		QA_##a##_Data(const QA_##a##_Data &data) : fFace(data.fFace), CAATData(fTag, ProdString(""), kInvalidUICode) {} \
		\
		virtual ~QA_##a##_Data() {} \
		\
		virtual VirtualType GetType(void); \
...
{ 
	public: 
		...
		QA_QAFile_Data(QAFile var, ProdString tag, 
						...
						ProdString uiString = "", 
						ProdInt32 code = kInvalidUICode) : fFace(var), CAATData(tag, uiString, varName, code) {} 
		QA_QAFile_Data(const QA_QAFile_Data &data) : fFace(data.fFace), CAATData(fTag, ProdString(""), kInvalidUICode) {} 
